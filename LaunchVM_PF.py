...
if __name__ == "__main__":
    ...
    # print("------------------------------------------------------")
    # raw_input('Availability set created. Press enter to continue...')
    #
    # # Create a public IP address
    # creation_result = create_public_ip_address(network_client)
    # print("------------------------------------------------------")
    # print(creation_result)
    # raw_input('Public IP address created. Press enter to continue...')
    #
    # # Create the virtual network
    # creation_result = create_vnet(network_client)
    # print("------------------------------------------------------")
    # print(creation_result)
    # raw_input('Virtual Network Created. Press enter to continue...')
    #
    # # Add the subnet to the virtual network
    # creation_result = create_subnet(network_client)
    # print("------------------------------------------------------")
    # print(creation_result)
    # raw_input('Subnet added to virtual network. Press enter to continue...')
    #
    # # Create the network interface
    # creation_result = create_nic(network_client)
    # print("------------------------------------------------------")
    # print(creation_result)
    # raw_input('Network Interface created. Press enter to continue...')

    # FINALLY Create the virtual machine
    # creation_result = create_vm(network_client, compute_client)
    # print("------------------------------------------------------")
    # print(creation_result)
    # raw_input('Virtual Machine Created. Press enter to continue...')
    #
    ...
    # print("------------------------------------------------------")
    # raw_input('Info Displayed. Press enter to continue...')
    #
    # # Stop the VM
    # stop_vm(compute_client)
    # raw_input('VM Stopped. Press enter to continue...')
    #
    # # Deallocate the VM
    # deallocate_vm(compute_client)
    # raw_input('VM Deallocated.  Press enter to continue...')

    # Start the VM back up again
    start_vm(compute_client)
    raw_input('VM up and running again, Press enter to continue')

    # # Resize the VM
    # update_result = update_vm(compute_client)
    # print("------------------------------------------------------")
    # print(update_result)
    # raw_input('VM has been resized. Press enter to continue...')
    #
    # # Add Data Disk to VM
